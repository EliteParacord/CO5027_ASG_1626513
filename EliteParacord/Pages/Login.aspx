...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="auto-style8">
        <div id="Login-block-1">
            ...
            <p>Password<asp:TextBox ID="TxtLoginPassword" runat="server" CssClass="auto-style2" Width="247px" TextMode="Password"></asp:TextBox>
            </p>
            <p>
        ...
        <p> Password<asp:TextBox ID="TxtPasswordReg" runat="server" CssClass="auto-style6" Width="300px" TextMode="Password"></asp:TextBox>
        </p>
        <p> Confirm Password<asp:TextBox ID="TxtConfirmPassReg" runat="server" CssClass="auto-style7" Width="298px" TextMode="Password"></asp:TextBox>
        </p>
        <p> 
